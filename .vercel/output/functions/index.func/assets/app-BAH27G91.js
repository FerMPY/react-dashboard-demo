    ...
    if (isArrayImpl(children))
      for (var i = 0; i < children.length; i++)
        (nameSoFar = children[i]),
          (type2 = nextNamePrefix + getElementKey(nameSoFar, i)),
      ...
      (function () {
        ...
        function getComponentNameFromType(type2) {
          ...
          if ("function" === typeof type2)
            return type2.$$typeof === REACT_CLIENT_REFERENCE$2
              ? null
              : type2.displayName || type2.name || null;
          ...
          if ("object" === typeof type2)
            switch (
              ...
              case REACT_FORWARD_REF_TYPE:
                ...
                type2 ||
                  ((type2 = innerType.displayName || innerType.name || ""),
                  (type2 =
                    "" !== type2 ? "ForwardRef(" + type2 + ")" : "ForwardRef"));
                return type2;
              case REACT_MEMO_TYPE:
                return (
                  (innerType = type2.displayName || null),
                  null !== innerType
                    ? innerType
                    : getComponentNameFromType(type2.type) || "Memo"
                );
              case REACT_LAZY_TYPE:
        ...
        function isValidElementType(type2) {
          return "string" === typeof type2 ||
            "function" === typeof type2 ||
            ...
            type2 === REACT_OFFSCREEN_TYPE ||
            ("object" === typeof type2 &&
              null !== type2 &&
              (type2.$$typeof === REACT_LAZY_TYPE ||
                type2.$$typeof === REACT_MEMO_TYPE ||
                type2.$$typeof === REACT_CONTEXT_TYPE ||
                type2.$$typeof === REACT_CONSUMER_TYPE ||
                type2.$$typeof === REACT_FORWARD_REF_TYPE ||
                type2.$$typeof === REACT_CLIENT_REFERENCE$1 ||
                void 0 !== type2.getModuleId))
            ? true
            : false;
        }
        ...
        function describeUnknownElementTypeFrameInDEV(type2) {
          ...
          if ("object" === typeof type2)
            switch (type2.$$typeof) {
              case REACT_FORWARD_REF_TYPE:
                return (
                  (type2 = describeNativeComponentFrame(type2.render, false)),
                  type2
                );
              case REACT_MEMO_TYPE:
        ...
        function validateChildKeys(node2, parentType) {
          if (
            "object" === typeof node2 &&
            node2 &&
            node2.$$typeof !== REACT_CLIENT_REFERENCE
          ) {
            if (isArrayImpl(node2))
              ...
              ((i = getIteratorFn(node2)),
              "function" === typeof i &&
                i !== node2.entries &&
                ((i = i.call(node2)), i !== node2))
            )
              for (; !(node2 = i.next()).done; )
                isValidElement(node2.value) &&
                  validateExplicitKey(node2.value, parentType);
          }
        }
        function isValidElement(object) {
          return (
        ...
        function getElementKey(element, index) {
          return "object" === typeof element &&
            null !== element &&
            null != element.key
            ? (checkKeyStringCoercion(element.key), escape2("" + element.key))
            : index.toString(36);
        }
        function noop$1() {}
        function resolveThenable(thenable) {
        ...
        function mapIntoArray(
          ...
          if (isArrayImpl(children))
            for (var i = 0; i < children.length; i++)
              (nameSoFar = children[i]),
                (type2 = childKey + getElementKey(nameSoFar, i)),
                (invokeCallback += mapIntoArray(
                  nameSoFar,
                  array,
                  escapedPrefix,
        ...
        exports.createElement = function (type2, config, children) {
          if (isValidElementType(type2))
            ...
            if (
              ...
              ("object" === typeof type2 &&
                null !== type2 &&
                0 === Object.keys(type2).length)
            )
              i +=
                " You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.";
            if (null === type2) var typeString = "null";
            else
              isArrayImpl(type2)
                ? (typeString = "array")
                : void 0 !== type2 && type2.$$typeof === REACT_ELEMENT_TYPE
                  ? ((typeString =
                      "<" +
                      (getComponentNameFromType(type2.type) || "Unknown") +
                      " />"),
                    (i =
          ...
          if (type2 && type2.defaultProps)
            for (propName in ((childrenLength = type2.defaultProps),
            childrenLength))
              void 0 === i[propName] &&
          ...
          typeString &&
            defineKeyPropWarningGetter(
              i,
              "function" === typeof type2
                ? type2.displayName || type2.name || "Unknown"
                : type2,
            );
          return ReactElement(type2, typeString, void 0, void 0, getOwner(), i);
        };
        ...
        exports.memo = function (type2, compare) {
          ...
          Object.defineProperty(compare, "displayName", {
            ...
            set: function (name) {
              ...
              type2.name ||
                type2.displayName ||
                (Object.defineProperty(type2, "name", { value: name }),
...
function convertRoutesToDataRoutes(
  ...
  return routes.map((route2, index) => {
    ...
    invariant(
      route2.index !== true || !route2.children,
...
function convertRouteMatchToUiMatch(match, loaderData) {
  let { route: route2, pathname, params } = match;
  return {
    id: route2.id,
    pathname,
    params,
...
function flattenRoutes(
  ...
  routes.forEach((route2, index) => {
    ...
    if (
      route2.path === "" ||
      !((_a = route2.path) == null ? void 0 : _a.includes("?"))
    ) {
...
var ErrorResponseImpl = class {
  constructor(status, statusText, data2, internal2 = false) {
    this.status = status;
...
function createStaticHandler(routes, opts) {
  ...
  async function query2(
    ...
    if (!isValidMethod(method) && method !== "HEAD") {
      ...
      let { matches: methodNotAllowedMatches, route: route2 } =
      ...
      let { matches: notFoundMatches, route: route2 } =
        getShortCircuitMatches(dataRoutes);
      return {
        basename,
        location,
...
async function convertDataStrategyResultToDataResult(dataStrategyResult) {
  ...
  if (isResponse(result)) {
    let data2;
    try {
      let contentType2 = result.headers.get("Content-Type");
      if (contentType2 && /\bapplication\/json\b/.test(contentType2)) {
        if (result.body == null) {
          data2 = null;
        } else {
...
function normalizeRelativeRoutingRedirectResponse(
  ...
  let location = response2.headers.get("Location");
  invariant(
    location,
  ...
  if (!ABSOLUTE_URL_REGEX.test(location)) {
    ...
    response2.headers.set("Location", location);
  }
  return response2;
}
...
function getInternalRouterError(
  status,
  { pathname, routeId, method, type: type2, message } = {},
) {
...
function useRouteContext(hookName) {
  ...
  invariant(route2, getDataRouterConsoleError(hookName));
  return route2;
}
...
function mapRouteProperties(route2) {
  let updates = {
    ...
    hasErrorBoundary:
      route2.hasErrorBoundary ||
      route2.ErrorBoundary != null ||
      route2.errorElement != null,
  };
  if (route2.Component) {
    {
      if (route2.element) {
    ...
    Object.assign(updates, {
      element: reactExports.createElement(route2.Component),
      Component: void 0,
    });
  }
  if (route2.HydrateFallback) {
    {
      if (route2.hydrateFallbackElement) {
        warning(
          false,
    ...
    Object.assign(updates, {
      hydrateFallbackElement: reactExports.createElement(
        route2.HydrateFallback,
      ),
  ...
  if (route2.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: reactExports.createElement(route2.ErrorBoundary),
...
async function loadRouteModule(route2, routeModulesCache) {
  if (route2.id in routeModulesCache) {
    return routeModulesCache[route2.id];
  }
  try {
    ...
    routeModulesCache[route2.id] = routeModule;
    return routeModule;
  } catch (error) {
    console.error(
      `Error loading route module \`${route2.module}\`, reloading page...`,
    );
    console.error(error);
    if (
...
function getKeyedLinksForMatches(matches, routeModules, manifest) {
  let descriptors = matches
    .map((match) => {
      ...
      let route2 = manifest.routes[match.route.id];
      return [
        route2 && route2.css
          ? route2.css.map((href) => ({ rel: "stylesheet", href }))
          : [],
...
async function getKeyedPrefetchLinks(matches, manifest, routeModules) {
  let links = await Promise.all(
    matches.map(async (match) => {
      let route2 = manifest.routes[match.route.id];
      if (route2) {
        let mod = await loadRouteModule(route2, routeModules);
...
function getModuleLinkHrefs(matches, manifestPatch) {
  return dedupeHrefs(
    matches
      .map((match) => {
        let route2 = manifestPatch.routes[match.route.id];
        if (!route2) return [];
        let hrefs = [route2.module];
        if (route2.imports) {
          hrefs = hrefs.concat(route2.imports);
        }
        return hrefs;
      })
      .flat(1),
  ...
  return decode(body, {
    plugins: [
      (type2, ...rest) => {
        ...
        if (type2 === "ErrorResponse") {
          let [data2, status, statusText] = rest;
          return {
            value: new ErrorResponseImpl(status, statusText, data2),
          };
        }
        if (type2 === "SingleFetchRedirect") {
          return { value: { [SingleFetchRedirectSymbol]: rest[0] } };
        }
        if (type2 === "SingleFetchClassInstance") {
          return { value: rest[0] };
        }
        if (type2 === "SingleFetchFallback") {
          return { value: void 0 };
        }
      },
    ],
...
function groupRoutesByParentId(manifest) {
  let routes = {};
  Object.values(manifest).forEach((route2) => {
    if (route2) {
      let parentId = route2.parentId || "";
      if (!routes[parentId]) {
        routes[parentId] = [];
      }
      routes[parentId].push(route2);
    }
  });
  return routes;
}
function getRouteComponents(route2, routeModule, isSpaMode) {
  let Component4 = getRouteModuleComponent(routeModule);
  let HydrateFallback =
    routeModule.HydrateFallback && (!isSpaMode || route2.id === "root")
  ...
  let ErrorBoundary = routeModule.ErrorBoundary
    ...
    : route2.id === "root"
      ...
      : void 0;
  if (route2.id === "root" && routeModule.Layout) {
    return {
      ...(Component4
        ? {
...
function createServerRoutes(
  ...
  return (routesByParentId[parentId] || []).map((route2) => {
    let routeModule = routeModules[route2.id];
    invariant2(
      routeModule,
      "No `routeModule` available to create server routes",
    );
    let dataRoute = {
      ...getRouteComponents(route2, routeModule, isSpaMode),
      ...
      // proper fallback
      loader: route2.hasLoader || route2.hasClientLoader ? () => null : void 0,
...
function shouldHydrateRouteLoader(route2, routeModule, isSpaMode) {
  return (
    (isSpaMode && route2.id !== "root") ||
    (routeModule.clientLoader != null &&
      (routeModule.clientLoader.hydrate === true || route2.hasLoader !== true))
  );
}
...
import(${JSON.stringify(manifest.entry.module)});`;
  ...
  let routePreloads = matches
    .map((match) => {
      let route2 = manifest.routes[match.route.id];
      return route2 ? (route2.imports || []).concat([route2.module]) : [];
    })
    .flat(1);
...
function createStaticRouter(routes, context, opts = {}) {
  ...
  let matches = context.matches.map((match) => {
    let route2 = manifest[match.route.id] || match.route;
    return {
      ...match,
      route: route2,
    };
...
function ServerRouter({ context, url, nonce }) {
  ...
  for (let match of context.staticHandlerContext.matches) {
    ...
    let route2 = routeModules[routeId];
    let manifestRoute = context.manifest.routes[routeId];
    if (
      route2 &&
      manifestRoute &&
      shouldHydrateRouteLoader(manifestRoute, route2, context.isSpaMode) &&
      (route2.HydrateFallback || !manifestRoute.hasLoader)
    ) {
...
function createRoutes(
  ...
  return (routesByParentId[parentId] || []).map((route2) => ({
    ...route2,
    children: createRoutes(manifest, route2.id, routesByParentId),
  }));
}
function createStaticHandlerDataRoutes(
  ...
  return (routesByParentId[parentId] || []).map((route2) => {
    let commonRoute = {
      ...
      hasErrorBoundary:
        route2.id === "root" || route2.module.ErrorBoundary != null,
      id: route2.id,
      path: route2.path,
      // Need to use RR's version in the param typed here to permit the optional
      // context even though we know it'll always be provided in remix
      loader: route2.module.loader
        ? async (args) => {
            if (args.request.headers.has("X-React-Router-Prerender-Data")) {
              ...
              invariant3(
                data2 && route2.id in data2,
                "Unable to decode prerendered data",
              );
              let result = data2[route2.id];
              invariant3(
                "data" in result,
            ...
            let val = await callRouteHandler(route2.module.loader, args);
            return val;
          }
        : void 0,
      action: route2.module.action
        ? (args) => callRouteHandler(route2.module.action, args)
        : void 0,
      handle: route2.module.handle,
    };
    return route2.index
      ? {
          index: true,
...
function getDocumentHeaders(build, context) {
  ...
  return matches.reduce((parentHeaders, match, idx) => {
    let { id } = match.route;
    let route2 = build.routes[id];
    invariant3(route2, `Route with id "${id}" not found in build`);
    let routeModule = route2.module;
...
async function singleFetchLoaders(
  ...
  try {
    ...
    let loadRouteIds =
      ((_a = new URL(request2.url).searchParams.get("_routes")) == null
        ? void 0
        : _a.split(",")) || void 0;
    let result = await staticHandler.query(handlerRequest, {
      requestContext: loadContext,
    ...
    for (let path of url.searchParams.getAll("p")) {
      ...
      if (matches) {
        for (let match of matches) {
          let routeId = match.route.id;
          let route2 = build.assets.routes[routeId];
          if (route2) {
            patches[routeId] = route2;
          }
        }
      }
    }
...
function unwrapResponse(response2) {
  let contentType2 = response2.headers.get("Content-Type");
  return contentType2 && /\bapplication\/json\b/.test(contentType2)
    ? response2.body == null
      ? null
      : response2.json()
    : response2.text();
...
function createRemixRequest(req, res) {
  var _a, _b;
  let [, hostnamePort] =
    ((_a = req.get("X-Forwarded-Host")) == null ? void 0 : _a.split(":")) ?? [];
  let [, hostPort] =
    ((_b = req.get("host")) == null ? void 0 : _b.split(":")) ?? [];
  ...
  res.on("close", () => (controller == null ? void 0 : controller.abort()));
  if (req.method !== "GET" && req.method !== "HEAD") {
    init2.body = createReadableStreamFromReadable(req);
    init2.duplex = "half";
  }
  return new Request(url.href, init2);
}
async function sendRemixResponse(res, nodeResponse) {
  ...
  if (
    (_a = nodeResponse.headers.get("Content-Type")) == null
      ? void 0
      : _a.match(/text\/event-stream/i)
  ) {
    res.flushHeaders();
  }
  ...
  function eehaslisteners(emitter, type2) {
    var count =
      typeof emitter.listenerCount !== "function"
        ? emitter.listeners(type2).length
        : emitter.listenerCount(type2);
    return count > 0;
  }
...
function requireContentType() {
  ...
  function format(obj) {
    ...
    var type2 = obj.type;
    if (!type2 || !TYPE_REGEXP2.test(type2)) {
    ...
    function createError() {
      ...
      for (var i = 0; i < arguments.length; i++) {
        ...
        if (type2 === "object" && arg instanceof Error) {
          ...
          throw new TypeError(
            "argument #" + (i + 1) + " unsupported type " + type2,
          );
        }
      }
      ...
      if (
        ...
        (!statuses2.message[status] && (status < 400 || status >= 600))
      ) {
        status = 500;
      }
      ...
      if (!err) {
        err = HttpError
          ? new HttpError(msg)
          : new Error(msg || statuses2.message[status]);
  ...
  function destroyZlibStream(stream) {
    if (typeof stream.destroy === "function") {
      if (stream._binding) {
        ...
        stream._destroy &&
        stream._destroy !== Stream2.Transform.prototype._destroy
      ) {
        stream.destroy();
  ...
  Utf16Decoder.prototype.write = function (buf) {
    if (!this.decoder) {
      ...
      var buf = Buffer2.concat(this.initialBytes),
        encoding2 = detectEncoding(buf, this.options.defaultEncoding);
      ...
      if (!inBase64) {
        ...
        if (!base64IMAPChars[buf[i2]]) {
          if (i2 == lastI && buf[i2] == minusChar) {
            ...
            var b64str =
              base64Accum + buf.slice(lastI, i2).toString().replace(/,/g, "/");
            res += this.iconv.decode(
              Buffer2.from(b64str, "base64"),
              "utf16-be",
            );
...
function requireDbcsCodec() {
  ...
  DBCSCodec.prototype._setEncodeSequence = function (seq, dbcsCode) {
    ...
    for (var j = 1; j < seq.length - 1; j++) {
      ...
      if (typeof oldVal === "object") node2 = oldVal;
      else {
        node2 = node2[uCode] = {};
        if (oldVal !== void 0) node2[DEF_CHAR] = oldVal;
      }
    }
...
const gbChars = [
  ...
  38078, 39108, 39109, 39113, 39114, 39115, 39116, 39265, 39394, 189e3,
];
const require$$4 = {
  uChars,
  gbChars,
};
const require$$5 = JSON.parse(
  ...
  extendNode = function (iconv) {
    ...
    iconv.extendNodeEncodings = function extendNodeEncodings() {
      ...
      Buffer2.isEncoding = function (encoding2) {
        return (
          Buffer2.isNativeEncoding(encoding2) || iconv.encodingExists(encoding2)
        );
      };
...
function requireRead() {
  ...
  function read(req, res, next, parse2, debug2, options) {
    ...
    if (
      opts.encoding === null &&
      encoding2 !== null &&
      !iconv.encodingExists(encoding2)
    ) {
      return next(
        createError(
          415,
          'unsupported charset "' + encoding2.toUpperCase() + '"',
          {
    ...
    getBody(stream, opts, function (error, body) {
      ...
      try {
        debug2("parse body");
        str =
          typeof body !== "string" && encoding2 !== null
            ? iconv.decode(body, encoding2)
            : body;
        req.body = parse2(str);
      } catch (err) {
        next(
  ...
  function contentstream(req, debug2, inflate) {
    ...
    switch (encoding2) {
      ...
      default:
        throw createError(
          415,
          'unsupported content encoding "' + encoding2 + '"',
          {
            encoding: encoding2,
            type: "encoding.unsupported",
          },
    ...
    return function jsonParser(req, res, next) {
      ...
      if (charset2.slice(0, 4) !== "utf-") {
        ...
        next(
          createError(
            415,
            'unsupported charset "' + charset2.toUpperCase() + '"',
            {
              charset: charset2,
              type: "charset.unsupported",
            },
    ...
    for (var j = 0; j < string.length; j += limit) {
      ...
      for (var i = 0; i < segment.length; ++i) {
        ...
        if (
          ...
          (c >= 65 && c <= 90) ||
          (c >= 97 && c <= 122) ||
          (format === formats2.RFC1738 && (c === 40 || c === 41))
        ) {
      ...
      if (encoder) {
        ...
        return [
          formatter(keyValue) +
            "=" +
            formatter(
              encoder(obj, defaults.encoder, charset2, "value", format),
            ),
        ];
      }
...
function requireParse() {
  ...
  var normalizeParseOptions = function normalizeParseOptions2(opts) {
    ...
    return {
      ...
      delimiter:
        typeof opts.delimiter === "string" || utils2.isRegExp(opts.delimiter)
          ? opts.delimiter
          : defaults.delimiter,
...
function requireMergeDescriptors() {
  ...
  function merge(dest, src2, redefine) {
    ...
    Object.getOwnPropertyNames(src2).forEach(
...
function requireFinalhandler() {
  ...
  var escapeHtml3 = requireEscapeHtml();
  var onFinished2 = requireOnFinished();
  ...
  proto.handle = function handle(req, res, out) {
    ...
    function next(err) {
      ...
      req.params = self2.mergeParams
        ? mergeParams(layer2.params, parentParams)
        : layer2.params;
...
function requireSend() {
  ...
  SendStream.prototype.redirect = function redirect(path2) {
    ...
    var doc = createHtmlDocument(
      "Redirecting",
      "Redirecting to " + escapeHtml3(loc),
    );
    res.statusCode = 301;
    res.setHeader("Content-Type", "text/html; charset=UTF-8");
    res.setHeader("Content-Length", Buffer.byteLength(doc));
  ...
  SendStream.prototype.type = function type2(path2) {
    ...
    res.setHeader(
      "Content-Type",
      type3 + (charset2 ? "; charset=" + charset2 : ""),
    );
  };
...
function requireUtils() {
  ...
  (function (exports) {
    ...
    exports.normalizeType = function (type2) {
      return ~type2.indexOf("/")
        ? acceptParams(type2)
        : { value: mime.lookup(type2), params: {} };
    };
    ...
    function createETagGenerator(options) {
      return function generateETag(body, encoding2) {
        var buf = !Buffer2.isBuffer(body)
          ? Buffer2.from(body, encoding2)
          : body;
  ...
  (function (module, exports) {
    ...
    app2.render = function render(name, options, callback) {
      ...
      if (!view2) {
        ...
        if (!view2.path) {
          var dirs =
            Array.isArray(view2.root) && view2.root.length > 1
              ? 'directories "' +
                view2.root.slice(0, -1).join('", "') +
                '" or "' +
                view2.root[view2.root.length - 1] +
                '"'
              : 'directory "' + view2.root + '"';
          var err = new Error(
  ...
  res.redirect = function redirect(url) {
    ...
    this.format({
      ...
      html: function () {
        ...
        body =
          "<p>" + statuses2.message[status] + ". Redirecting to " + u + "</p>";
      },
      default: function () {
        body = "";
      },
...
app.use(
  createRequestHandler({
    ...
    build: () => import("./server-build-qHZsDO-a.js"),
    getLoadContext() {
      return {
